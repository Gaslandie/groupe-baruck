 ...
 * la hauteur de l'écran, comme demandé le 2026-09-17.
 */
const roleClassName = "role-link";

export function HeroIntro() {
  return (
    <div className="relative z-10 flex flex-col bg-paper px-[clamp(1.5rem,4vw,4.8rem)] pb-[clamp(4rem,6vh,5.5rem)] pt-[clamp(8rem,17vh,13rem)] text-ink max-tablet:min-h-[100svh] max-tablet:bg-transparent max-tablet:px-[1.3rem] max-tablet:pb-[clamp(5.5rem,13vh,7.5rem)] max-tablet:pt-[8rem] max-tablet:text-ivory">
