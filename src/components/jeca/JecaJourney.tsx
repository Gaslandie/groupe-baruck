  ...
  return (
    <section className="grid grid-cols-[1.1fr_.9fr] bg-jeca-blue text-white max-tablet:block">
      <div className="px-[clamp(1.3rem,6vw,7.5rem)] py-[clamp(5rem,8vw,8rem)] max-[1080px]:px-12 max-tablet:px-[1.3rem] max-tablet:py-20">
        ...
        <p className="mb-0 mt-8 max-w-[720px] text-body leading-[1.8] text-[rgba(255,255,255,.72)]">
      ...
      <div className="grid grid-rows-2 bg-white text-jeca-ink">
        <article className="relative flex min-h-[300px] flex-col justify-center overflow-hidden border-b border-jeca-line p-[clamp(2rem,5vw,5rem)] max-tablet:min-h-[260px] max-tablet:px-[1.3rem] max-tablet:py-10">
          <small className="relative text-micro font-extrabold uppercase tracking-[.15em] text-jeca-red">Première étape</small>
          <h3 className="relative mb-[.8rem] mt-4 font-display text-display-lg font-normal leading-[.92] tracking-[-.05em] text-jeca-blue">Côte d’Ivoire</h3>
          <p className="relative m-0 max-w-[400px] text-small leading-[1.7] text-jeca-muted">Mobiliser des Ivoiriens pour investir en Côte d’Ivoire.</p>
        </article>
        <article className="relative flex min-h-[300px] flex-col justify-center overflow-hidden p-[clamp(2rem,5vw,5rem)] max-tablet:min-h-[260px] max-tablet:px-[1.3rem] max-tablet:py-10">
          <small className="relative text-micro font-extrabold uppercase tracking-[.15em] text-jeca-red">Étape suivante</small>
          <h3 className="relative mb-[.8rem] mt-4 font-display text-display-lg font-normal leading-[.92] tracking-[-.05em] text-jeca-blue">Guinée Conakry</h3>
          <p className="relative m-0 max-w-[400px] text-small leading-[1.7] text-jeca-muted">20 hectares acquis pour un projet autour du manioc et d’une usine d’attiéké.</p>
        </article>
      </div>
    </section>
  );
