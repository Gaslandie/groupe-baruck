...
Le choix des images est désormais intégré au formulaire : couverture et galerie avec aperçus, recherche, import depuis l’ordinateur, ordre modifiable et retrait sans saisie de chemins. La médiathèque propose le téléchargement des fichiers importés. Les parcours sont testés dans Chrome avec conservation du texte en cours, et les contrôles d’accès et de fichiers sont vérifiés côté PHP/MySQL. Les fichiers restent privés tant qu’ils ne sont pas inclus dans une publication validée.

La suite concerne l’éditeur et son aperçu, la sauvegarde automatique avant fermeture et les contrôles SEO éditoriaux. Une recette des parcours sur mobile, au clavier et avec Mohamed reste nécessaire avant de qualifier l’expérience d’aboutie. La boutique reste hors périmètre.
